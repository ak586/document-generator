...
export const COURSE_CATALOG: CourseDefinition[] = [
  ...
  { id: "bpt", shortName: "B.Ph.T", fullName: "Bachelor in Physiotherapy", durationYears: 4, referenceCode: "BPT" },
  { id: "bot", shortName: "B.Th.O", fullName: "Bachelor in Occupational Therapy", durationYears: 4, referenceCode: "BOCT" },
